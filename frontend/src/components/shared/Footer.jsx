...
const Footer = () => {
  return (
    <footer className="py-8 bg-[#2B3A41] text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0 text-[#03AF75]">
            <a href="https://facebook.com" className="hover:text-white hover:bg-[#03AF75] bg-[white]" aria-label="Facebook">
            ...
            <a href="https://linkedin.com" className="hover:text-white hover:bg-[#03AF75] bg-[white]" aria-label="LinkedIn">
